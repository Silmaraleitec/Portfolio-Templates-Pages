...
// função anônima que substitui o querySelector no mapeamento das informações - retorna item

const cs = (el) => document.querySelectorAll(el);
// retorna um arrray dos itens
...
c('.pizzaInfo--addButton').addEventListener('click', () => {
    //qual pizza? //qual tamanho? //quantas pizzas?
